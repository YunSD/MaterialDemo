...
public class BreadcrumbBar : System.Windows.Controls.ItemsControl
{
    ...
    /// </summary>
    public Input.IRelayCommand TemplateButtonCommand => (Input.IRelayCommand)GetValue(TemplateButtonCommandProperty);
    ...
    {
        SetValue(TemplateButtonCommandProperty, new Input.RelayCommand<object>(OnTemplateButtonClick));
