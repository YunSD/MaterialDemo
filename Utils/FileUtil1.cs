...
namespace MaterialDemo.Utils
{
    public class FileUtil1
    {
        ...
        private static ILog logger = LogManager.GetLogger(nameof(FileUtil1));
        ...
        public static bool IsEmptyDirectory(string directoryPath)
        {
            ...
            {
                logger.Error("FileUtil:IsEmptyDirectory;Common", ex);
                return true;
            }
        }
        #endregion
        ...
        public static bool Contains(string directoryPath, string searchPattern)
        {
            ...
            {
                logger.Error("FileUtil:Contains();Common", ex);
                return false;
            }
        }
        /// <summary>
