namespace MaterialDemo.Utils
{
    public class SnowflakeIdWorker
    {
        ...
        #region 单例:完全懒汉
        private static readonly Lazy<SnowflakeIdWorker> lazy = new Lazy<SnowflakeIdWorker>(() => new SnowflakeIdWorker());
        public static SnowflakeIdWorker Singleton { get { return lazy.Value; } }
        private SnowflakeIdWorker() { }
        #endregion

        public SnowflakeIdWorker(long cid, long mid)
        {
